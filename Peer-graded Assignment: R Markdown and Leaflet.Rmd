...
monumenticon <- makeIcon(iconUrl = "~/School-01-128.png", iconWidth = 31*215/230, iconHeight = 31, iconAnchorX = 31*215/230/2, iconAnchorY = 16)
...
df %>% leaflet() %>% 
  addTiles() %>% 
  addMarkers(icon = monumenticon, popup = monumentsite)
